...
void setname(){
  if(recognize.id=0){string name = Alongkorn;}
  if(recognize.id=1){string name = Supakrit;}
  /*if(recognize.id=2){string name = ..;}
  if(recognize.id=3){string name = ..;}
  ....................*/
